...
第五,本评测的全部 harness(适配器、driver、finish、judge)、原始 context / answers / score、证据台账(30 条)、研究结构化数据(13 工具)都在 `runs/2026-07-03-memory-systems-eval/` 下可复现。任何结论都可以回到原始证据核对。
...
本评测的全部产物都在 `runs/2026-07-03-memory-systems-eval/` 下,任何人可以复现:
