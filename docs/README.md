...
1. 让所有公开专题都有稳定入口、系列目录和有效内部链接。
2. 为一手评测补齐可复现脚本、版本信息和原始结果摘要。
3. 完善 AI Coding 同任务横向评测。
4. 建设 Model API 与本地模型选型专题。
5. 把项目收藏继续整理成按场景、身份和验证状态可筛选的条目。
6. 建设贡献模板、内容保鲜机制和自动化质量门。
