...
<!-- wos:illustration codex-engineering/43-remote-handoff/01-infographic-concept-map.svg -->
![Notion 图解：TL;DR](../../../assets/ai-coding-engineering-illustrations/codex-engineering/43-remote-handoff/01-infographic-concept-map.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/43-remote-handoff/02-timeline-lifecycle-timeline.svg -->
![Notion 图解：先把三种「远程」分开](../../../assets/ai-coding-engineering-illustrations/codex-engineering/43-remote-handoff/02-timeline-lifecycle-timeline.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/43-remote-handoff/03-framework-system-framework.svg -->
![Notion 图解：Handoff 的数据路径](../../../assets/ai-coding-engineering-illustrations/codex-engineering/43-remote-handoff/03-framework-system-framework.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/43-remote-handoff/04-flowchart-operating-flow.svg -->
![Notion 图解：交接前冻结一个可验证状态](../../../assets/ai-coding-engineering-illustrations/codex-engineering/43-remote-handoff/04-flowchart-operating-flow.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/43-remote-handoff/05-infographic-verification-guardrails.svg -->
![Notion 图解：两个公开问题揭示的失败模式](../../../assets/ai-coding-engineering-illustrations/codex-engineering/43-remote-handoff/05-infographic-verification-guardrails.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/43-remote-handoff/06-comparison-boundary-comparison.svg -->
![Notion 图解：安全边界](../../../assets/ai-coding-engineering-illustrations/codex-engineering/43-remote-handoff/06-comparison-boundary-comparison.svg)
<!-- /wos:illustration -->
