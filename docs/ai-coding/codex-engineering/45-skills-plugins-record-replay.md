...
<!-- wos:illustration codex-engineering/45-skills-plugins-record-replay/01-flowchart-operating-flow.svg -->
![Notion 图解：TL;DR](../../../assets/ai-coding-engineering-illustrations/codex-engineering/45-skills-plugins-record-replay/01-flowchart-operating-flow.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/45-skills-plugins-record-replay/02-infographic-concept-map.svg -->
![Notion 图解：三个名词其实是三种工件](../../../assets/ai-coding-engineering-illustrations/codex-engineering/45-skills-plugins-record-replay/02-infographic-concept-map.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/45-skills-plugins-record-replay/03-framework-system-framework.svg -->
![Notion 图解：Skill 是能力说明，不是后台服务](../../../assets/ai-coding-engineering-illustrations/codex-engineering/45-skills-plugins-record-replay/03-framework-system-framework.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/45-skills-plugins-record-replay/04-timeline-lifecycle-timeline.svg -->
![Notion 图解：Plugin 解决的是分发和组合](../../../assets/ai-coding-engineering-illustrations/codex-engineering/45-skills-plugins-record-replay/04-timeline-lifecycle-timeline.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/45-skills-plugins-record-replay/05-infographic-verification-guardrails.svg -->
![Notion 图解：权限链不能随 Plugin 一起打包转移](../../../assets/ai-coding-engineering-illustrations/codex-engineering/45-skills-plugins-record-replay/05-infographic-verification-guardrails.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/45-skills-plugins-record-replay/06-comparison-boundary-comparison.svg -->
![Notion 图解：何时停在 Skill，何时升级为 Plugin](../../../assets/ai-coding-engineering-illustrations/codex-engineering/45-skills-plugins-record-replay/06-comparison-boundary-comparison.svg)
<!-- /wos:illustration -->
