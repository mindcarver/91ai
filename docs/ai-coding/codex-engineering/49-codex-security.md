...
<!-- wos:illustration codex-engineering/49-codex-security/01-framework-system-framework.svg -->
![Notion 图解：TL;DR](../../../assets/ai-coding-engineering-illustrations/codex-engineering/49-codex-security/01-framework-system-framework.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/49-codex-security/02-comparison-boundary-comparison.svg -->
![Notion 图解：从威胁模型开始，而不是从配置项开始](../../../assets/ai-coding-engineering-illustrations/codex-engineering/49-codex-security/02-comparison-boundary-comparison.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/49-codex-security/03-flowchart-operating-flow.svg -->
![Notion 图解：第一层：项目边界与受保护路径](../../../assets/ai-coding-engineering-illustrations/codex-engineering/49-codex-security/03-flowchart-operating-flow.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/49-codex-security/04-infographic-verification-guardrails.svg -->
![Notion 图解：第二层：沙箱与审批必须分开理解](../../../assets/ai-coding-engineering-illustrations/codex-engineering/49-codex-security/04-infographic-verification-guardrails.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/49-codex-security/05-infographic-concept-map.svg -->
![Notion 图解：第三层：网络出口和网页检索是两个控制面](../../../assets/ai-coding-engineering-illustrations/codex-engineering/49-codex-security/05-infographic-concept-map.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/49-codex-security/06-timeline-lifecycle-timeline.svg -->
![Notion 图解：第四层：凭据不要进入代理可见上下文](../../../assets/ai-coding-engineering-illustrations/codex-engineering/49-codex-security/06-timeline-lifecycle-timeline.svg)
<!-- /wos:illustration -->
