...
<!-- wos:illustration codex-engineering/44-hooks-trust-lifecycle/01-flowchart-operating-flow.svg -->
![Notion 图解：TL;DR](../../../assets/ai-coding-engineering-illustrations/codex-engineering/44-hooks-trust-lifecycle/01-flowchart-operating-flow.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/44-hooks-trust-lifecycle/02-infographic-verification-guardrails.svg -->
![Notion 图解：先把 Hook 看成机场安检通道](../../../assets/ai-coding-engineering-illustrations/codex-engineering/44-hooks-trust-lifecycle/02-infographic-verification-guardrails.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/44-hooks-trust-lifecycle/03-framework-system-framework.svg -->
![Notion 图解：当前生命周期事件](../../../assets/ai-coding-engineering-illustrations/codex-engineering/44-hooks-trust-lifecycle/03-framework-system-framework.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/44-hooks-trust-lifecycle/04-infographic-concept-map.svg -->
![Notion 图解：Hash trust 审核了什么](../../../assets/ai-coding-engineering-illustrations/codex-engineering/44-hooks-trust-lifecycle/04-infographic-concept-map.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/44-hooks-trust-lifecycle/05-timeline-lifecycle-timeline.svg -->
![Notion 图解：Hook 输出怎样控制生命周期](../../../assets/ai-coding-engineering-illustrations/codex-engineering/44-hooks-trust-lifecycle/05-timeline-lifecycle-timeline.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/44-hooks-trust-lifecycle/06-comparison-boundary-comparison.svg -->
![Notion 图解：权衡与局限](../../../assets/ai-coding-engineering-illustrations/codex-engineering/44-hooks-trust-lifecycle/06-comparison-boundary-comparison.svg)
<!-- /wos:illustration -->
