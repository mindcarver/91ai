...
<!-- wos:illustration codex-engineering/39-thread-history-memory-import/01-timeline-lifecycle-timeline.svg -->
![Notion 图解：TL;DR](../../../assets/ai-coding-engineering-illustrations/codex-engineering/39-thread-history-memory-import/01-timeline-lifecycle-timeline.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/39-thread-history-memory-import/02-infographic-concept-map.svg -->
![Notion 图解：先分清四个盒子](../../../assets/ai-coding-engineering-illustrations/codex-engineering/39-thread-history-memory-import/02-infographic-concept-map.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/39-thread-history-memory-import/03-flowchart-operating-flow.svg -->
![Notion 图解：Thread History 怎样恢复任务](../../../assets/ai-coding-engineering-illustrations/codex-engineering/39-thread-history-memory-import/03-flowchart-operating-flow.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/39-thread-history-memory-import/04-comparison-boundary-comparison.svg -->
![Notion 图解：Memory 是召回层，不是规则层](../../../assets/ai-coding-engineering-illustrations/codex-engineering/39-thread-history-memory-import/04-comparison-boundary-comparison.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/39-thread-history-memory-import/05-infographic-verification-guardrails.svg -->
![Notion 图解：/import 究竟从 Claude Code 和 Cursor 搬了什么](../../../assets/ai-coding-engineering-illustrations/codex-engineering/39-thread-history-memory-import/05-infographic-verification-guardrails.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration codex-engineering/39-thread-history-memory-import/06-framework-system-framework.svg -->
![Notion 图解：Cursor 有原生导入，仍要做语义验收](../../../assets/ai-coding-engineering-illustrations/codex-engineering/39-thread-history-memory-import/06-framework-system-framework.svg)
<!-- /wos:illustration -->
