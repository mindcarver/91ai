...
<!-- wos:illustration claude-code-engineering/44-claude-tag-team-entrypoint/01-infographic-concept-map.svg -->
![Notion 图解：TL;DR](../../../assets/ai-coding-engineering-illustrations/claude-code-engineering/44-claude-tag-team-entrypoint/01-infographic-concept-map.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration claude-code-engineering/44-claude-tag-team-entrypoint/02-flowchart-operating-flow.svg -->
![Notion 图解：一次 @Claude 请求的真实路径](../../../assets/ai-coding-engineering-illustrations/claude-code-engineering/44-claude-tag-team-entrypoint/02-flowchart-operating-flow.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration claude-code-engineering/44-claude-tag-team-entrypoint/03-infographic-verification-guardrails.svg -->
![Notion 图解：频道与私聊不是同一种身份](../../../assets/ai-coding-engineering-illustrations/claude-code-engineering/44-claude-tag-team-entrypoint/03-infographic-verification-guardrails.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration claude-code-engineering/44-claude-tag-team-entrypoint/04-timeline-lifecycle-timeline.svg -->
![Notion 图解：与旧版 Claude in Slack 的关系](../../../assets/ai-coding-engineering-illustrations/claude-code-engineering/44-claude-tag-team-entrypoint/04-timeline-lifecycle-timeline.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration claude-code-engineering/44-claude-tag-team-entrypoint/05-framework-system-framework.svg -->
![Notion 图解：记忆、记录与协作边界](../../../assets/ai-coding-engineering-illustrations/claude-code-engineering/44-claude-tag-team-entrypoint/05-framework-system-framework.svg)
<!-- /wos:illustration -->
...
<!-- wos:illustration claude-code-engineering/44-claude-tag-team-entrypoint/06-comparison-boundary-comparison.svg -->
![Notion 图解：权衡与局限](../../../assets/ai-coding-engineering-illustrations/claude-code-engineering/44-claude-tag-team-entrypoint/06-comparison-boundary-comparison.svg)
<!-- /wos:illustration -->
