...
<!-- codex:cover ../../../assets/claude-code-engineering/03-project-map-cover.png -->
![Claude Code 系列文章封面：Claude Code 为什么总不懂你的项目？缺一张「项目地图」](../../../assets/claude-code-engineering/03-project-map-cover.png)
<!-- /codex:cover -->
