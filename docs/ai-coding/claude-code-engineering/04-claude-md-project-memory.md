...
<!-- codex:cover ../../../assets/claude-code-engineering/04-claude-md-project-memory-cover.png -->
![Claude Code 系列文章封面：CLAUDE.md：这不是写给人看的文档，而是写给 AI 的上下文](../../../assets/claude-code-engineering/04-claude-md-project-memory-cover.png)
<!-- /codex:cover -->
