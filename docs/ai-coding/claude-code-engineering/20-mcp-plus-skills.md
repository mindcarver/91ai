...
<!-- codex:cover ../../../assets/claude-code-engineering/20-mcp-plus-skills-cover.png -->
![Claude Code 系列文章封面：MCP 给能力，Skill 教流程：工具才能按团队 SOP 被用对](../../../assets/claude-code-engineering/20-mcp-plus-skills-cover.png)
<!-- /codex:cover -->
