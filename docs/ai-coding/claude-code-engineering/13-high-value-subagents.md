...
<!-- codex:cover ../../../assets/claude-code-engineering/13-high-value-subagents-cover.png -->
![Claude Code 系列文章封面：最先值得配置的三类 Subagent：探索、审查、测试](../../../assets/claude-code-engineering/13-high-value-subagents-cover.png)
<!-- /codex:cover -->
