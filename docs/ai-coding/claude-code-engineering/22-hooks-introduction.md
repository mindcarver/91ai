...
<!-- codex:cover ../../../assets/claude-code-engineering/22-hooks-introduction-cover.png -->
![Claude Code 系列文章封面：Hooks 入门：从「相信 AI 守规矩」到「强制 AI 守规矩」](../../../assets/claude-code-engineering/22-hooks-introduction-cover.png)
<!-- /codex:cover -->
