...
<!-- codex:cover ../../../assets/claude-code-engineering/06-common-workflows-cover.png -->
![Claude Code 系列文章封面：读代码、修 Bug、补测试、写文档：四套拿来即用的工作流模板](../../../assets/claude-code-engineering/06-common-workflows-cover.png)
<!-- /codex:cover -->
