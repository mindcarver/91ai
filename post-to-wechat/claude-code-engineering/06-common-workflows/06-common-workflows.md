...
![Claude Code 系列文章封面：读代码、修 Bug、补测试、写文档：四套拿来即用的工作流模板](media/01-06-common-workflows-cover.png)
<!-- /codex:cover -->
...
![图解：为什么要从这四个工作流开始](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：工作流 1 · 解释代码](media/03-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：工作流质量诊断矩阵](media/04-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：真实失败案例](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
