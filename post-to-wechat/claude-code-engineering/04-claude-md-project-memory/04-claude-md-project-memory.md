...
![Claude Code 系列文章封面：CLAUDE.md：这不是写给人看的文档，而是写给 AI 的上下文](media/01-04-claude-md-project-memory-cover.png)
<!-- /codex:cover -->
...
![图解：CLAUDE.md 是工程规格，不是文档](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：内容分层策略 · 什么放哪里](media/03-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：CLAUDE.md vs Hooks …](media/04-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：失败案例 · 400 行的 CLAUD…](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
