...
![Claude Code 系列文章封面：结构化输出：让 Agent 的产出能被下一段代码直接接住](media/01-30-structured-output-cover.png)
<!-- /codex:cover -->
...
![图解：输出格式决策矩阵](media/03-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：JSON Schema 设计模式](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：集成模式 · 结构化输出到下游系统](media/05-02-framework-core-structure.png)
<!-- /codex:illustration -->
