...
![Claude Code 系列文章封面：MCP 心智模型：外部数据不是用来复制粘贴的，而是工具接口](media/01-17-mcp-mental-model-cover.png)
<!-- /codex:cover -->
...
![图解：为什么需要 MCP · 复制粘贴的工程…](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：协议架构 · 三个角色的职责边界](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：决策矩阵 · 接还是不接](media/04-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：MCP 接入的工程纪律](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
