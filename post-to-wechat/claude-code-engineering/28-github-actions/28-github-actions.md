...
![Claude Code 系列文章封面：GitHub Actions：让 Claude Code 自动 Review PR、分类 Issue、修小 Bug](media/01-28-github-actions-cover.png)
<!-- /codex:cover -->
...
![图解：核心架构](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：真实 Workflow 配置](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：权限策略矩阵](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
