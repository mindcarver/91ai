...
![Claude Code 系列文章封面：Hooks 入门：从「相信 AI 守规矩」到「强制 AI 守规矩」](media/01-22-hooks-introduction-cover.png)
<!-- /codex:cover -->
...
![图解：为什么需要 Hooks](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：系统架构](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：Hook 执行流程](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：Hook 与 Permission S…](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
