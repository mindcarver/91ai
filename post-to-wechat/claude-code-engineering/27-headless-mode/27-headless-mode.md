...
![Claude Code 系列文章封面：Headless 模式：把 Claude Code 装进脚本里跑](media/01-27-headless-mode-cover.png)
<!-- /codex:cover -->
...
![图解：Headless 架构](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：决策矩阵 · Headless vs …](media/04-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：输入输出管道设计](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
