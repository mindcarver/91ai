...
![Claude Code 系列文章封面：Plugins：把 Commands、Skills、Hooks、MCP 打包成一套跨项目分发](media/01-32-plugins-cover.png)
<!-- /codex:cover -->
...
![图解：Plugin 作为分发单元](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：分发策略](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：失败案例 · 第三方 Plugin 窃…](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
