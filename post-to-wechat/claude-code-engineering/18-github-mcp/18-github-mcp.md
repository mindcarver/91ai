...
![Claude Code 系列文章封面：第一个 MCP：让 Claude Code 直接读懂你的 Issue、PR 和代码](media/01-18-github-mcp-cover.png)
<!-- /codex:cover -->
...
![图解：为什么 GitHub 是第一个 MCP](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：Issue Triage 工作流 · …](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：PR Review 工作流 · 代码上…](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：失败案例 · Token 权限过大导致…](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
