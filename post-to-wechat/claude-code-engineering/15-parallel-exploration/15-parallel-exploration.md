...
![Claude Code 系列文章封面：并行探索：让多个 Subagent 分头研究，再汇总成一个结论](media/01-15-parallel-exploration-cover.png)
<!-- /codex:cover -->
...
![图解：并行派发架构](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：结果整合策略](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：Token 成本对比](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
