...
![图解：为什么 MCP 单独使用效果有限](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：从工具到流程 · 一个比喻](media/03-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：Skill 如何影响 MCP 的 To…](media/04-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：边界设计 · 什么放 Skill，什么…](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
