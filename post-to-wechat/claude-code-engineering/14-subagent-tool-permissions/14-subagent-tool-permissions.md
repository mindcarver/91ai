...
![Claude Code 系列文章封面：工具权限：为什么「只读审计」代理绝不能拿到写权限](media/01-14-subagent-tool-permissions-cover.png)
<!-- /codex:cover -->
...
![图解：工具权限架构](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：权限升级矩阵](media/04-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：权限降级策略](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
