...
![Claude Code 系列文章封面：.claude/rules：CLAUDE.md 臃肿了，就把规则拆成按路径加载的小块](media/01-05-rules-path-scoped-context-cover.png)
<!-- /codex:cover -->
...
![图解：Rules 系统架构](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：Monorepo Rules 分层策略](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：Rules vs CLAUDE.md …](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
