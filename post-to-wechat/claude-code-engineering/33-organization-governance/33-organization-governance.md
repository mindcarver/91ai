...
![Claude Code 系列文章封面：组织级治理：多团队长期跑下去，靠的是版本、审计、评测和升级策略](media/01-33-organization-governance-cover.png)
<!-- /codex:cover -->
...
![图解：治理框架概述](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：治理对象清单](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：失败案例 · 50 人无治理推广](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
