...
![Claude Code 系列文章封面：MCP 的暗面：Token 爆炸、越权、工具投毒与提示注入](media/01-21-mcp-risks-cover.png)
<!-- /codex:cover -->
...
![图解：为什么 MCP 风险需要专门讨论](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：威胁模型总览](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：MCP 安全审计清单](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：失败案例 · 第三方 MCP serv…](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
