...
![Claude Code 系列文章封面：CI 里的安全边界：别让一个外部 PR 偷走你的 Secrets](media/01-29-ci-security-boundaries-cover.png)
<!-- /codex:cover -->
...
![图解：威胁模型](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：安全审计清单](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：失败案例 · 提示注入导致 PR 自动…](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
