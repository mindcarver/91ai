...
![Claude Code 系列文章封面：Agent SDK：把 Claude Code 的 agent loop 嵌进自己的平台](media/01-31-agent-sdk-cover.png)
<!-- /codex:cover -->
...
![图解：SDK 架构深度剖析 · 三个核心原语](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：决策矩阵 · 本地 CLI vs Ag…](media/04-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：生产部署模式](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
