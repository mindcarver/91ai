...
![Claude Code 系列文章封面：从安装到第一个真实任务：Claude Code 的权限模式怎么选](media/01-02-setup-permission-first-repo-task-cover.png)
<!-- /codex:cover -->
...
![图解：安装与认证](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：四种权限模式深度对比](media/03-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：第一个任务 · 诊断框架](media/04-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：落地验证清单](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
