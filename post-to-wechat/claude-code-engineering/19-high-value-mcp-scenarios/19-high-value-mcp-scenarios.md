...
![Claude Code 系列文章封面：数据库、监控、设计系统：真正值得接入的高价值 MCP 场景](media/01-19-high-value-mcp-scenarios-cover.png)
<!-- /codex:cover -->
...
![图解：从 GitHub MCP 到多系统 M…](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：场景评估框架](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：场景四 · 设计系统（Figma）](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：Token 消耗和延迟对比](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
