...
![Claude Code 系列文章封面：Subagents 的本质：不是多了一个 AI，而是开了一个独立上下文](media/01-12-subagents-mental-model-cover.png)
<!-- /codex:cover -->
...
![图解：系统设计视角](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：失败分析](media/04-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：落地清单](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
