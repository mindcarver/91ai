...
![Claude Code 工程代理运行时封面](media/01-claude-code-agent-runtime-cover.png)
...
![图解：定位 · 为什么"更强的 ChatGP…](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：四层架构深度解析](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：系统对比 · 架构视角](media/04-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：运行时生命周期](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
