...
![Claude Code 系列文章封面：最先值得配置的三类 Subagent：探索、审查、测试](media/01-13-high-value-subagents-cover.png)
<!-- /codex:cover -->
...
![图解：任务路由策略](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：Subagent 配置性能对比](media/04-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：扩展策略](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
