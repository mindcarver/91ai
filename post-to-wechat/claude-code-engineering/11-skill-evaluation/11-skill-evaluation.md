...
![Claude Code 系列文章封面：Skill 不触发、乱触发、跑挂了：一份评测与调优指南](media/01-11-skill-evaluation-cover.png)
<!-- /codex:cover -->
...
![图解：三类失败模式深度拆解](media/03-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：触发精度诊断工作流](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：迭代工作流](media/05-02-framework-core-structure.png)
<!-- /codex:illustration -->
