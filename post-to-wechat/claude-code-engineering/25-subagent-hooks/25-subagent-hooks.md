...
![Claude Code 系列文章封面：Subagent Hooks：给子代理注入上下文，再把结果收回来](media/01-25-subagent-hooks-cover.png)
<!-- /codex:cover -->
...
![图解：问题 · 子代理的上下文隔离是一把双刃剑](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：SubagentStart 与 Age…](media/03-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：Subagent Hook 的配置层级](media/04-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：Subagent Hooks 与主会话…](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
