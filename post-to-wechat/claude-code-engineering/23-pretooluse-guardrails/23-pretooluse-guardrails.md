...
![Claude Code 系列文章封面：PreToolUse：危险命令和高风险写入执行之前，先拦下来](media/01-23-pretooluse-guardrails-cover.png)
<!-- /codex:cover -->
...
![图解：为什么 PreToolUse 是第一道…](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：Hook 脚本 1 · 文件保护](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：渐进式部署策略](media/04-03-flow-operating-loop.png)
<!-- /codex:illustration -->
...
![图解：误判诊断工作流](media/05-04-compare-guardrails.png)
<!-- /codex:illustration -->
