...
![Claude Code 系列文章封面：不该用 Subagent 的场景：共享细节和连续编辑](media/01-16-when-not-to-use-subagents-cover.png)
<!-- /codex:cover -->
...
![图解：反模式目录](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：方案对比矩阵](media/04-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：反模式 6 · 自动化测试生成的 su…](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
