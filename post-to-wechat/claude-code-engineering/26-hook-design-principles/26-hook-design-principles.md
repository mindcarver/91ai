...
![Claude Code 系列文章封面：Hook 怎么写才不翻车：小、确定、可解释、可回滚](media/01-26-hook-design-principles-cover.png)
<!-- /codex:cover -->
...
![图解：Hook 的治理定位](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：决策矩阵 · Hook vs Rule…](media/03-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：反模式 · 生产环境中的 Hook 失…](media/04-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：Hook 测试策略](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
