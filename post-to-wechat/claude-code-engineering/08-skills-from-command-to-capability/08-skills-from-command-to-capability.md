...
![Claude Code 系列文章封面：命令写到第三遍就该升级了：什么时候该从命令变成 Skill](media/01-08-skills-from-command-to-capability-cover.png)
<!-- /codex:cover -->
...
![图解：Command 和 Skill 的系统…](media/02-01-overview-knowledge-map.png)
<!-- /codex:illustration -->
...
![图解：决策矩阵 · 什么时候该升级](media/03-04-compare-guardrails.png)
<!-- /codex:illustration -->
...
![图解：真实升级案例 ·  /review →…](media/04-02-framework-core-structure.png)
<!-- /codex:illustration -->
...
![图解：升级执行步骤](media/05-03-flow-operating-loop.png)
<!-- /codex:illustration -->
