...
**Filename**: 02-timeline-lifecycle-timeline.svg

## Illustration 3

**Position**: Handoff 的数据路径 / 首个说明段落之后
...
**Position**: 交接前冻结一个可验证状态 / 首个说明段落之后
...
**Filename**: 04-flowchart-operating-flow.svg

## Illustration 5

**Position**: 两个公开问题揭示的失败模式 / 首个说明段落之后
