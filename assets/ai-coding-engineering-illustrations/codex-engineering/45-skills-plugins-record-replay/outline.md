...
**Position**: Skill 是能力说明，不是后台服务 / 首个说明段落之后
...
**Position**: Plugin 解决的是分发和组合 / 首个说明段落之后
...
**Position**: 权限链不能随 Plugin 一起打包转移 / 首个说明段落之后
...
**Position**: 何时停在 Skill，何时升级为 Plugin / 首个说明段落之后
