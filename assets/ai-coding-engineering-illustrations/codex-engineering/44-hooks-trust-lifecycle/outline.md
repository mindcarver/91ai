...
**Position**: 先把 Hook 看成机场安检通道 / 首个说明段落之后
...
**Filename**: 02-infographic-verification-guardrails.svg

## Illustration 3

**Position**: 当前生命周期事件 / 首个说明段落之后
...
**Position**: Hash trust 审核了什么 / 首个说明段落之后
...
**Position**: Hook 输出怎样控制生命周期 / 首个说明段落之后
